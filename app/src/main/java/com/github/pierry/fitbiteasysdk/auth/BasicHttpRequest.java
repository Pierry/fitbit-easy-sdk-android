package com.github.pierry.fitbiteasysdk.auth;
...
public class BasicHttpRequest {
  ...
  private String getQuery(List<Pair<String, String>> params) throws UnsupportedEncodingException {
    ...
    for (Pair<String, String> pair : params) {
      keyValues.add(URLEncoder.encode(pair.first, "UTF-8") + "=" + URLEncoder.encode(pair.second, "UTF-8"));
    }
  ...
  public synchronized BasicHttpResponse execute() throws IOException {
    ...
    try {
      ...
      return new BasicHttpResponse(connection.getResponseCode(), readBytes(connection.getInputStream()));
    } finally {
      if (connection != null) {
